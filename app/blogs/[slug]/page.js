    ...
    return  <article>
        ...
        <div className='grid grid-cols-12 gap-16 mt-8 px-10'>
            <div className='col-span-4'>
                <details className='border-[1px] border-solid border-black text-black rounded-lg p-4 sticky top-6 
                            ...
                            blog.toc.map((heading) => {
                                ...
                                return <li key={`#${heading.slug}`} className='py-1'>
                                    ...
                                    data-[level=three]:pl-6 flex items-center justify-start'>
                                        ...
                                        {heading.level === "three" ? <span 
                                        className='flex w-1 h-1 rounded-full bg-dark mr-2'></span> : null}
